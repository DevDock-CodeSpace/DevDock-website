...
_Last updated: 2026-09-25 (Phase 4d: Team → Workspace frontend)_
...
| 4e: UI redesign (Linear/Notion-style) | 🟡 Built; checks pass; visually inspected with mocked data (light, dark, mobile); not yet reviewed with real accounts | `feat/workspace-roles` |
